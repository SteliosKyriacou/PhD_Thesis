...
Four archived designs are retrieved and used as the design space basis vectors in order to create the optimization variables as proposed by the KBD method. 
\pagebreak
