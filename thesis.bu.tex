...
\frontmatter
\include{0_frontmatter/committee}
...
\include{2/Chapter2}					% EAs
\include{3/Chapter3}					% KBD
\include{4/Chapter4}					% PCA
\include{5/Chapter5}					% HYDRO
\include{6/Chapter6}					% NTUA CASCADE
